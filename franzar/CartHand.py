...
class handler(tornado.web.RequestHandler):
    def get(self):
        ...
        if UserCartItems != "":
            UserCartItems += "<div id=\"CIc\" style=\"top:{0:s}px;\"><h1 id=\"CICSt\">Shipping Address</h1><h2 id=\"CICs\">{1:s}</h2><h1 id=\"CICBt\">Billing Address</h1><h2 id=\"CICb\">{2:s}</h2><h1 id=\"CICPt\">Payment Method</h1><h2 id=\"CICp\">{3:s}</h2><h6 id=\"CICRt\">Redeem a gift card:</h6><input type=\"text\" id=\"CICr\" placeholder=\"Enter code here\" maxlength=\"20\"><h3 id=\"CICt\">Total: {4:s}{5:,.2f}</h3></div>".format(str(UserCartListLen*210),"0000 Street Name Rd Apt #1000<br>New York, NY 00000-0000<br>United States","0000 Street Name Rd Apt #1000<br>New York, NY 00000-0000<br>United States","Card ending in 0000<br>$100.00 gift card balance",UserCurrencySymbol,UserCartListTotal)
