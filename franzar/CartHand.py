...
class handler(tornado.web.RequestHandler):
    def get(self):
        ...
        if UserCartItems != "":
            ...
            UserShippingAddress = "0001 Street Name Rd Apt #1000<br>New York, NY 00000-0000<br>United States"
            ...
            UserCartItems += "<div id=\"CIc\" style=\"top:{0:s}px;\"><h1 id=\"CICSt\">Shipping Address</h1><h2 id=\"CICs\">{1:s}</h2><h1 id=\"CICBt\">Billing Address</h1><h2 id=\"CICb\">{2:s}</h2><h1 id=\"CICPt\">Payment Method</h1><h2 id=\"CICp\">{3:s}</h2><h6 id=\"CICRt\">Redeem a gift card:</h6><input type=\"text\" id=\"CICr\" placeholder=\"Enter code here\" maxlength=\"20\">{4:s}</div>".format(str(UserCartListLen*210),UserShippingAddress,UserBillingAddress,UserBillingInfoSet,UserCartTotalsSet)
