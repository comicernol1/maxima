...
class handler(tornado.web.RequestHandler):
    def get(self):
        ...
        if UserCartItems != "":
            ...
            UserSalesTaxRate = CalculateSalesTax(self,"us","nc")
            UserCartListTaxes = round((UserCartListTotal*UserSalesTaxRate), 2)
            ...
            CartIndex = CartIndex.replace("<% SalesTaxRate %>",str(UserSalesTaxRate))
