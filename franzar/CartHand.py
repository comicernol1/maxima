...
class handler(tornado.web.RequestHandler):
    def get(self):
        ...
        if UserCartItems != "":
            UserCartItems += "<div id=\"CIc\" style=\"top:"+str(UserCartListLen*210)+"px;\"><h1 id=\"CICSt\">Shipping Address</h1><h2 id=\"CICs\">0000 Street Name Rd Apt #1000<br>New York, NY 00000-0000<br>United States</h2><h1 id=\"CICBt\">Billing Address</h1><h2 id=\"CICb\">0000 Street Name Rd Apt #1000<br>New York, NY 00000-0000<br>United States</h2><h1 id=\"CICPt\">Payment Method</h1><h2 id=\"CICp\">Card ending in 0000<br>$100.00 gift card balance</h2><h6 id=\"CICRt\">Redeem a gift card:</h6><input type=\"text\" id=\"CICr\" placeholder=\"Enter redemption code here\" maxlength=\"16\"></div>"
