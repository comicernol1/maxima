...
class CartHand(tornado.web.RequestHandler):
    def get(self):
        ...
        for i in range(0,len(UserCartList)):
            ...
            UserCartItems += "<div class=\"CIt\" style=\"top:"+str(i*210)+"px;\"><input type=\"number\" value=\""+str(UserCartList[i][1])+"\"><a href=\"/product/"+UserCartItem_ID+"/\" class=\"CIi\" style=\"background-image:url("+UserCartItem_ImgLink+");\"></a><h3>"+FindProduct(UserCartItem_ID)["Name"]+"</h3><h1>"+UserCartItem_PriceSet+"</h1></div>\n"
