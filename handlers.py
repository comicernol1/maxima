...
class CartHand(tornado.web.RequestHandler):
    def get(self):
        ...
        for i in range(0,len(UserCartList)):
            ...
            UserCartItems += "<div class=\"CIt\" style=\"top:"+str(i*300)+"px;\"><div class=\"CIi\" style=\"background-image:url("+UserCartItem_ImgLink+");\"></div><h1>"+FindProduct(UserCartItem_ID)["Name"]+"</h1><input type=\"number\" value=\""+str(UserCartList[i][1])+"\"></div>\n"
