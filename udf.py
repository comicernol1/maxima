...
def CreateCookie(self,cookie_name: str,cookie_value: str,cookie_expires: int,*args,**kwargs):
    ...
    self.set_header("Set-Cookie",str(cookie_name)+"="+str(cookie_value)+"; Domain:"+RequestedHostBase+"; "+ExpiresDateString+"Path:/;"+str(cookie_name)+"="+str(cookie_value)+"; Domain:www."+RequestedHostBase+"; "+ExpiresDateString+"Path:/;")
